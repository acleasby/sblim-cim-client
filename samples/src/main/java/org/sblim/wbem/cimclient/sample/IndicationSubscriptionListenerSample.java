...
public class IndicationSubscriptionListenerSample implements CIMListener {
    ...
    public static void main(String args[]) {
        ...
        String cimAgentAddress = "https://10.100.202.38:5989";
        String namespace = "root/cimv2";
        String user = "root";
        String pw = "silverbells";

        IndicationSubscriptionListenerSample ic = new IndicationSubscriptionListenerSample(cimAgentAddress, namespace, user, pw);

        if (!ic.startServer()) {
            System.out.println("Listener not started. End sample program");
            return;
        }
        ...
        try {
            ...
            try {
                ...
                e.printStackTrace();
                System.out.println("Problem during subscription. Exiting.");
                return;
            }
